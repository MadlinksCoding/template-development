...
// Smoothed Line Chart Main Function
function FansSmoothLineChart(renderingEl, data) {
    // Create root element
    var root = am5.Root.new(renderingEl);
    root._logo.dispose();
    ...
    function addSeries(name, fieldName, color) {
        var series = chart.series.push(am5xy.SmoothedXLineSeries.new(root, {
            ...
            tooltip: am5.Tooltip.new(root, {
                ...
                labelText: "[font color='#667085' fontFamily: 'Poppins' fontWeight:600 fontSize: .75rem]{day} [/]\n[font color='{stroke}' fontSize: 16px]● [/][font color='#344054' fontFamily: 'Poppins' fontWeight:400 fontSize: .75rem]{name}\t\t\t[/][font color='#101828' fontFamily: 'Poppins' fontWeight:500 fontSize: .75rem]{valueY}[/]", // Custom tooltip 
